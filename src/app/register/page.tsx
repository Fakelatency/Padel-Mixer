        ...
        <div className="min-h-screen flex items-center justify-center px-4">
            <div className="w-full max-w-md">
                <div className="text-center mb-8 animate-fade-in">
                    ...
                    <h1 className="text-2xl font-bold text-white mb-1">{t.register}</h1>
                    <p className="text-navy-300 text-sm">{t.registerSubtitle}</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="glass-card-static p-6 space-y-4 animate-slide-up" style={{ opacity: 0, animationDelay: '0.1s' }}>
                    ...
                    <div>
                        <label className="block text-sm font-medium text-navy-300 mb-1.5">{t.playerName}</label>
                        <input
                            type="text"
                            value={name}
